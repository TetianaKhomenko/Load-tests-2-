Feature('Mark as completed/not completed 127 @step-06 @S0d6da388')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 127 @Te779ffd9', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 127 @Tf41dbe34', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 127 @T11df163c', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 127 @T05fbf960', async ({ I, TodosPage }) => {
