Feature('@first Create Todos 125 @step:06 @smoke @story:12545 @S96a4f81c')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 125 @T78206780', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 125 @Tf308b46f', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 125 @T15a2bc65', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 125 @T3bd406d1', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 125 @T8d8e61f6', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 125 @T1a8c949c', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 125 @Ta4c165b6', async ({ I, TodosPage }) => {
