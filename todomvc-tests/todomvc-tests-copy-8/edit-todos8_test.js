Feature('Edit/Delete Todos 77 @step-06 @S7e942bb6')
...
Scenario('Edited todo is saved on blur 77 @Tbc923239', async ({ I, TodosPage }) => {
...
Scenario('Delete todos 77 @Ta2ef61bc', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
