Feature('Edit/Delete Todos 128 @step-06 @Sdb29422c')
...
Scenario('Edited todo is saved on blur 128 @Td2ae802e', async ({ I, TodosPage }) => {
...
Scenario('Delete todos 128 @T0e4fab19', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
