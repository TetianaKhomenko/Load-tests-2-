Feature('Mark as completed/not completed 66 @step-06 @S6672a234')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 66 @T9c4b615a', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 66 @Te5a562c5', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 66 @T7b04e9fd', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 66 @Tfcbf7f9e', async ({ I, TodosPage }) => {
