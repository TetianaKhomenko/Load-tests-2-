Feature('Mark as completed/not completed 44 @step-06 @Sdbe29d93')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 44 @Tf57b1aad', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 44 @T9b82f4f6', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 44 @Te6b60e10', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 44 @T218f885f', async ({ I, TodosPage }) => {
