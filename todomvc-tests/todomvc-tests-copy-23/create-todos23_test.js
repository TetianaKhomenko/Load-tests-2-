Feature('@first Create Todos 123 @step:06 @smoke @story:12345 @Sbd2e1f49')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 123 @T7a78c88d', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 123 @Ta92228f7', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 123 @Tfb17fe38', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 123 @T67948de0', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 123 @Te5a413dd', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 123 @Td4b185f5', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 123 @T8a07fa8c', async ({ I, TodosPage }) => {
