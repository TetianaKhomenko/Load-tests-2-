Feature('Mark as completed/not completed 123 @step-06 @S5dea119b')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 123 @T0319c897', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 123 @T84ef506d', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 123 @Tacd0b265', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 123 @Te0c461ea', async ({ I, TodosPage }) => {
