Feature('Mark as completed/not completed 115 @step-06')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 115', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 115', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 115', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 115', async ({ I, TodosPage }) => {
