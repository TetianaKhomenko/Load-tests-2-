Feature('Mark as completed/not completed 115 @step-06 @S3f4aeee3')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 115 @Tfd4efcf9', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 115 @Tfd8443a5', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 115 @Tbbf1ad11', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 115 @Tc251fa90', async ({ I, TodosPage }) => {
