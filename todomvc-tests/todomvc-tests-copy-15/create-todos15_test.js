Feature('@first Create Todos 115 @step:06 @smoke @story:12345 @S364d138f')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 115 @T9f445948', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 115 @T94f2aa18', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 115 @T284d69b4', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 115 @T2e1ec80d', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 115 @Tc3477636', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 115 @T85385302', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 115 @T6789cd58', async ({ I, TodosPage }) => {
