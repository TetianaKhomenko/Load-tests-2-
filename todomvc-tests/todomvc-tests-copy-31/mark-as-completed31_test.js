Feature('Mark as completed/not completed 131 @step-06 @Safa3aa35')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 131 @Ta5d2503b', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 131 @Td67b89fa', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 131 @Tc30964ed', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 131 @Tc4d9d2b3', async ({ I, TodosPage }) => {
