Feature('Mark as completed/not completed 55 @step-06 @S4216403f')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 55 @T800a2d66', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 55 @Tb1401189', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 55 @T0ddded36', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 55 @T58be47b5', async ({ I, TodosPage }) => {
