Feature('Mark as completed/not completed 118 @step-06 @Sa1a64939')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 118 @Tba59e371', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 118 @T4c009933', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 118 @Tc1ed9a2b', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 118 @T6c757927', async ({ I, TodosPage }) => {
