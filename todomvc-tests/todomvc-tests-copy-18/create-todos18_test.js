Feature('@first Create Todos 118 @step:06 @smoke @story:12345 @S513962b0')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 118 @T5d01a40b', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 118 @T18af3040', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 118 @T0c19c749', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 118 @Tdc775a55', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 118 @Tc159efad', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 118 @Tdae43226', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 118 @Tea774fb1', async ({ I, TodosPage }) => {
