Feature('Mark as completed/not completed2 @step-06')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed2', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos2', async ({ I, TodosPage }) => {
