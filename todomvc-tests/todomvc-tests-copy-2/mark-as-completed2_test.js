Feature('Mark as completed/not completed2 @step-06 @Sb2c87818')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed2 @T51706721', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos2 @T83226724', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed2 @Tc8e6b4db', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos2 @Tc16d7159', async ({ I, TodosPage }) => {
