Feature('Mark as completed/not completed 129 @step-06 @S927f94bf')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 129 @T01b7fce6', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 129 @Tf437f9a2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 129 @T9849dc1e', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 129 @Te8d05e93', async ({ I, TodosPage }) => {
