Feature('@first Create Todos 129 @step:06 @smoke @story:12345 @Sbf58580a')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 129 @T6efaf502', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 129 @T14108257', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 129 @Tf90eeba5', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 129 @T6dac39a5', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 129 @T94033253', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 129 @T393cd387', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 129 @Tb6fc8bc6', async ({ I, TodosPage }) => {
