Feature('Mark as completed/not completed 111 @step-06 @Sf9fe9849')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 111 @T293fbb50', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 111 @T2fcd0f3c', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 111 @T1342f522', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 111 @T9cc71519', async ({ I, TodosPage }) => {
