Feature('@first Create Todos 111 @step:06 @smoke @story:12345 @S6f5cf619')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 111 @T13e6e796', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 111 @Tc58a9e06', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 111 @Tcdeeeffd', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 111 @Tc02fa386', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 111 @Tc231eefe', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 111 @T6321b851', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 111 @T972e7134', async ({ I, TodosPage }) => {
