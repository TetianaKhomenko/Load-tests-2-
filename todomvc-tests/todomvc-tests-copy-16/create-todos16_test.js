Feature('@first Create Todos 116 @step:06 @smoke @story:12345 @S809b00c6')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 116 @T6a7b9eda', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 116 @T0617c4b9', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 116 @T587e0852', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 116 @T54b5ab8b', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 116 @Tde12c9dc', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 116 @T261dd966', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 116 @Tb08c396e', async ({ I, TodosPage }) => {
