Feature('Edit/Delete Todos 22 @step-06 @Sddc18210')
...
Scenario('Edited todo is saved on blur 22 @Tb2250b66', async ({ I, TodosPage }) => {
...
Scenario('Delete todos 22 @Te716c320', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
