Feature('Mark as completed/not completed 22 @step-06 @S122f7b89')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 22 @Ta6764e70', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 22 @Tac74eed2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 22 @Tdeec1e66', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 22 @T52ddfab4', async ({ I, TodosPage }) => {
