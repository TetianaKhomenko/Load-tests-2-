Feature('@first Create Todos 22 @step:06 @smoke @story:12345 @S0916ddf5')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 22 @T1560cb34', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 22 @Te2b9c26f', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 22 @T3dbe4844', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 22 @T2b39aa95', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 22 @T8b3d773a', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 22 @Tdb8e9d10', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 22 @T3bc58f10', async ({ I, TodosPage }) => {
