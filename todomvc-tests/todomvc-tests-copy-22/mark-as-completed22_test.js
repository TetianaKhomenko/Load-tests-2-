Feature('Mark as completed/not completed 122 @step-06 @Sc2df0d24')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 122 @Te4a3c5ac', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 122 @Tf4c6b8ad', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 122 @T69de3f16', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 122 @Tfbbc7c12', async ({ I, TodosPage }) => {
