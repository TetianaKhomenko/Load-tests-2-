Feature('Mark as completed/not completed @step-06 @S923da846')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @T8bf11167', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @T986b84fa', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @T7fa2f850', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @T898980b9', async ({ I, TodosPage }) => {
