 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed @T862a3f4d', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos @T7764139b', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed @Tecf396df', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos @T60e4e490', async ({ I, TodosPage }) => {
