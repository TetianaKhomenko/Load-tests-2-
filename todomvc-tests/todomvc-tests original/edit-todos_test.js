Feature('Edit/Delete Todos @step-06 @Sbcbd730b')
...
Scenario('Edited todo is saved on blur @Tb925af26', async ({ I, TodosPage }) => {
...
Scenario('Delete todos @Tc2c755f2', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
