Feature('@first Create Todos @step:06 @smoke @story:12345 @S363a5e1a')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item @T99526482', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items @Tca35ab0c', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters @Tb4345527', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item @Tcfe9e315', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed @Te7582028', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list @T3355a99c', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs @Te824ecff', async ({ I, TodosPage }) => {
