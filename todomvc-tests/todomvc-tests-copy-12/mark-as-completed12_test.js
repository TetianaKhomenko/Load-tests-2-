Feature('Mark as completed/not completed 112 @step-06 @Sdd583f77')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 112 @T339e2bee', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 112 @T7f889213', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 112 @T66941f3d', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 112 @T99ea026e', async ({ I, TodosPage }) => {
