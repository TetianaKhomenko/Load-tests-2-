Feature('@first Create Todos 112 @step:06 @smoke @story:12345 @Sa78bf6ac')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 112 @T4427e1e1', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 112 @Tff1b3229', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 112 @T35425a19', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 112 @T309b699e', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 112 @T1a399f2f', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 112 @Tcc1a9745', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 112 @Tb7ba17ca', async ({ I, TodosPage }) => {
