Feature('@first Create Todos 99 @step:06 @smoke @story:12345 @Sc2c5e767')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 99 @T7afc3c4d', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 99 @T1c32a927', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 99 @T01e54303', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 99 @T14b3746e', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 99 @Tc301ff29', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 99 @T7a0358ef', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 99 @T486d1ae4', async ({ I, TodosPage }) => {
