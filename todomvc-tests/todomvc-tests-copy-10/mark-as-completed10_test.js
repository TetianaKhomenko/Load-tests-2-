Feature('Mark as completed/not completed 99 @step-06 @S2074351b')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 99 @Tdc19b259', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 99 @T6dc204a9', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 99 @Tbf54d9ed', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 99 @Tb49b44e3', async ({ I, TodosPage }) => {
