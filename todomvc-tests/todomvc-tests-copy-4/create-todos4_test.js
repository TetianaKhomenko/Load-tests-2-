Feature('@first Create Todos 33 @step:06 @smoke @story:12345 @S49c3c3c3')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 33 @T4339919d', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 33 @T11145981', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 33 @T6f67be6d', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 33 @Tf6413248', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 33 @T3923f298', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 33 @T3ada61dd', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 33 @Tdd4eb3dd', async ({ I, TodosPage }) => {
