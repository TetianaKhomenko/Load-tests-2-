Feature('Mark as completed/not completed 33 @step-06 @Sbb965cda')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 33 @T439c44b8', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 33 @Tb3ea7a47', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 33 @T8d713b53', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 33 @T34dc666d', async ({ I, TodosPage }) => {
