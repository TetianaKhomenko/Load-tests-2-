Feature('Mark as completed/not completed 114 @step-06 @Sdc228ca5')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 114 @Tceb6c25e', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 114 @T18d5f636', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 114 @T36d4cbdd', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 114 @T0a39b8b0', async ({ I, TodosPage }) => {
