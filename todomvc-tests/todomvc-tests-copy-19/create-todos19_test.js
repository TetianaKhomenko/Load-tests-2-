Feature('@first Create Todos 119 @step:06 @smoke @story:12345 @Sb55b6e83')
 ...
 * Happy Path tests
 */
Scenario('Create a new todo item 119 @T44d83e77', async ({ I, TodosPage }) => {
...
Scenario('Create multiple todo items 119 @Tc27dcda5', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Data(examples).
Scenario('Todos containing weird characters 119 @Tded2f70f', async ({ I, current, TodosPage }) => {
...
Scenario('Text input field should be cleared after each item 119 @T37c5fc7f', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('Text input should be trimmed 119 @T2f2faa29', async ({ I, TodosPage }) => {
  I.say('Given I have an empty todo list')
...
Scenario('New todos should be added to the bottom of the list 119 @T5581a07b', async ({ I, TodosPage }) => {
...
Scenario('Footer should be visible when adding TODOs 119 @T80151086', async ({ I, TodosPage }) => {
