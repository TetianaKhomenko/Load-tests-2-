Feature('Mark as completed/not completed 113 @step-06 @See5d3120')
 ...
 * Happy Path tests
 */
Scenario('Mark todos as completed 113 @T7d7f8e44', async ({ I, TodosPage }) => {
...
Scenario('Unmark completed todos 113 @T954baa24', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Mark all todos as completed 113 @T116b3433', async ({ I, TodosPage }) => {
    I.say('Given I have some todos')
...
Scenario('Clear completed todos 113 @T955f04b7', async ({ I, TodosPage }) => {
